          ...
          <Row>
            <Col md={7} xs={9}>
              ...
              <p>
                ...
                tellus quam sollicitudin augue nunc.
              </p>
              <ul className='p-0 list-style-none list-inline'>
                <li className='list-inline-item mr-4'>
                  <img src={calendarBlackImg} alt='...' className='pr-2' /> May
                  20, 2021
                </li>

                <li className='list-inline-item'>
                  <img src={clockBlackImg} alt='...' className='pr-2' /> 6h 30
                  min
                </li>
              </ul>
            </Col>
          ...
          <Row>
            <Col md={6} xs={6}>
              <div className='first-test'>
                ...
                <p>
                  100% <br /> <img src={arrowRightImg} alt='' />
                </p>
              </div>
            </Col>
            <Col md={6} xs={6}>
